...
#predicting landmarks on face
face_detector = dlib.get_frontal_face_detector()

dlib_facelandmark = dlib.shape_predictor("C:\\Users\\hp\\Desktop\\drowsiness detection\\shape_predictor_68_face_landmarks.dat")
...
while True:
    ...
    for face in faces:
        ...
        # RIGHT EYES IN .DAT FILE THAT ARE FROM 42 TO 47
        for n in range(42, 48):
            ...
            # THESE ARE THE POINTS ALLOCATION FOR THE 
        # LEFT EYES IN .DAT FILE THAT ARE FROM 36 TO 41
        ...
        # CLOSE OR NOT
        cv2.putText(frame, "EAR "+str(Eye_Rat), (50, 100),
                        cv2.FONT_HERSHEY_PLAIN, 2, (21, 56, 210), 3)
        cv2.putText(frame, "BLINK"+str(blink_count), (500, 100),
                        cv2.FONT_HERSHEY_PLAIN, 2, (21, 56, 210), 3)
        cv2.putText(frame, "Time"+str(elapsed_time), (500, 200),
                        cv2.FONT_HERSHEY_PLAIN, 2, (21, 56, 210), 3)
